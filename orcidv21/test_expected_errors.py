...
class ExpectedErrors(OrcidBaseTest.OrcidBaseTest):
    ...
    def setUp(self):
        ...
        self.code2                = self.generate_auth_code(self.client_id,self.scope2,"api2PostUpdateCode")
    ...
    def test_update_record2_from_other_source(self):
        ...
        update_response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/%s/%s/%s" % (self.wrong_source_id, "work", str(putcode).strip()), update_curl_params)
