...
class OrcidBaseTest(unittest.TestCase):
    ...
    def remove_by_putcode(self, putcode, activity_type = "work"):
        ...
        try:
            response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/%s/%s/%s" % (self.orcid_id, activity_type, putcode), curl_params)
            return response
        except Exception as e:
    ...
    def post_activity(self, activity_type = "work", xml_file = "ma2_work.xml"):
        ...
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/%s/%s" % (self.orcid_id, activity_type) , curl_params)
        return response
    ...
    def update_activity(self, putcode, updated_data, activity_type = "work"):
        ...
        update_response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/%s/%s/%d" % (self.orcid_id, activity_type,int(putcode)), update_curl_params)
    ...
    def delete_activity(self, putcode, activity_type = "work"):
        ...
        delete_response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/%s/%s/%d" % (self.orcid_id, activity_type, int(putcode)), delete_curl_params)
    ...
    def read_record(self, token, endpoint = "record"):
        ...
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/%s/%s" % (self.orcid_id, endpoint) , curl_params)
        return response
