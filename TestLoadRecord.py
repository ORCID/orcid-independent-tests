...
test_cases = [junit_xml.TestCase('TestLoadRecord', 'orcidindependenttests.TestLoadRecord',TestLoadRecord),junit_xml.TestCase('Test1', 'some.class.name', 123.345, 'I am stdout!', 'I am stderr!')]
