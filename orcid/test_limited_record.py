...
class LimitedRecord(OrcidBaseTest.OrcidBaseTest):
    ...
    def test_read_limited_record_with_21_public_api(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_api_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://pub." + properties.test_server + "/v2.1/" + self.limited_orcid_id + "/record"curl_params, '--insecure')
        response_body = response.partition('X-Frame-Options: DENY')[2]
        response_body = re.sub('(.*)(X-Content-Type-Options: nosniff)|[    ](.*)(\<common:last-modified-date\>|\<common:created-date\>)(.*)(\</common:last-modified-date\>|\</common:created-date\>)\n','', response_body)
        #Compare the body of the response to the saved file.
    ...
    def test_read_limited_record_with_30_rc1_public_api(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_api_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://pub." + properties.test_server + "/v3.0_rc1/" + self.limited_orcid_id + "/record"curl_params, '--insecure')
        response_body = response.partition('X-Frame-Options: DENY')[2]
        response_body = re.sub('(.*)(X-Content-Type-Options: nosniff)|[    ](.*)(\<common:last-modified-date\>|\<common:created-date\>)(.*)(\</common:last-modified-date\>|\</common:created-date\>)\n','', response_body)
        #Compare the body of the response to the saved file.
    ...
    def test_read_limited_record_with_30_rc2_public_api(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_api_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://pub." + properties.test_server + "/v3.0_rc2/" + self.limited_orcid_id + "/record"curl_params, '--insecure')
        response_body = response.partition('X-Frame-Options: DENY')[2]
        response_body = re.sub('(.*)(X-Content-Type-Options: nosniff)|[	 ](.*)(\<common:last-modified-date\>|\<common:created-date\>)(.*)(\</common:last-modified-date\>|\</common:created-date\>)\n','', response_body)
        #Compare the body of the response to the saved file.
    ...
    def test_read_limited_work_with_20_public_api(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_api_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://pub." + properties.test_server + "/v2.0/" + self.limited_orcid_id + "/work/141942"curl_params, '--insecure')
    ...
    def test_read_limited_email_with_20_public_api(self):
        ...
        response = self.orcid_curl("https://pub." + properties.test_server + "/v2.0/" + self.limited_orcid_id + "/email"curl_params, '--insecure')
    ...
    def test_read_limited_email_with_30_rc1_public_api(self):
        ...
        curl_params = ['-H', "Accept: application/json", '-H', 'Authorization: Bearer ' + self.public_api_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://pub." + properties.test_server + "/v3.0_rc1/" + self.limited_orcid_id + "/email"curl_params, '--insecure')
        #Check an empty email sections is returned
        self.assertTrue(self.empty_email in response, "Non-empty email retruned " + response)
    ...
    def test_read_limited_email_with_30rc2_public_api(self):
        ...
        curl_params = ['-H', "Accept: application/json", '-H', 'Authorization: Bearer ' + self.public_api_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://pub." + properties.test_server + "/v3.0_rc2/" + self.limited_orcid_id + "/email"curl_params, '--insecure')
        #Check an empty email sections is returned
        self.assertTrue(self.empty_email in response, "Non-empty email retruned " + response)
    ...
    def test_read_limited_record_with_20_public_token(self):
        ...
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.0/" + self.limited_orcid_id + "/record"curl_params, '--insecure')
        response_body = response.partition('X-Frame-Options: DENY')[2]
        response_body = re.sub('(.*)(X-Content-Type-Options: nosniff)|[    ](.*)(\<common:last-modified-date\>|\<common:created-date\>)(.*)(\</common:last-modified-date\>|\</common:created-date\>)\n','', response_body)
        #Compare the body of the response to the saved file.
    ...
    def test_read_limited_work_with_20_public_token(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.0/" + self.limited_orcid_id + "/work/141942"curl_params, '--insecure')
    ...
    def test_read_limited_email_with_20_public_token(self):
        ...
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.0/" + self.limited_orcid_id + "/email"curl_params, '--insecure')
       	#Check an empty email sections is returned
        self.assertTrue(self.empty_email in response, "Non-empty email retruned " + response)
    ...
    def test_read_limited_record_with_21_public_token(self):
        #Test that reading a limited record with the 2.1 public api returns only the public info
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/" + self.limited_orcid_id + "/record"curl_params, '--insecure')
        response_body = response.partition('X-Frame-Options: DENY')[2]
        response_body = re.sub('(.*)(X-Content-Type-Options: nosniff)|[    ](.*)(\<common:last-modified-date\>|\<common:created-date\>)(.*)(\</common:last-modified-date\>|\</common:created-date\>)\n','', response_body)
        #Compare the body of the response to the saved file.
        self.assertTrue(response_body.strip() == open('saved_records/empty_limited_record21.xml','r').read(), 'response_body: ' + response_body)
    ...
    def test_read_limited_work_with_21_public_token(self):
        # TEST 144
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/" + self.limited_orcid_id + "/work/141942"curl_params, '--insecure')
        self.assertTrue("<error-code>9038</error-code>" in response, "Expected error code 9038 instead: " + response)

    def test_read_limited_email_with_21_public_token(self):
        # TEST 145
        curl_params = ['-H', "Accept: application/json", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/" + self.limited_orcid_id + "/email"curl_params, '--insecure')
        #Check an empty email sections is returned
        self.assertTrue(self.empty_email in response, "Non-empty email retruned " + response)
    ...
    def test_read_limited_funding_with_21_public_token(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v2.1/" + self.limited_orcid_id + "/funding/1285"curl_params, '--insecure')
        self.assertTrue("<error-code>9038</error-code>" in response, "Expected error code 9038 instead: " + response)

    def test_read_limited_record_with_30_rc1_public_token(self):
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc1/" + self.limited_orcid_id + "/record"curl_params, '--insecure')
        response_body = response.partition('X-Frame-Options: DENY')[2]
        response_body = re.sub('(.*)(X-Content-Type-Options: nosniff)|[    ](.*)(\<common:last-modified-date\>|\<common:created-date\>)(.*)(\</common:last-modified-date\>|\</common:created-date\>)\n','', response_body)
        #Compare the body of the response to the saved file.
        self.assertTrue(response_body.strip() == open('saved_records/empty_limited_record30_rc1.xml','r').read(), 'response_body: ' + response_body)
    ...
    def test_read_limited_work_with_30_rc1_public_token(self):
        # TEST 144
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc1/" + self.limited_orcid_id + "/work/141942"curl_params, '--insecure')
        self.assertTrue("<error-code>9038</error-code>" in response, "Expected error code 9038 instead: " + response)

    def test_read_limited_email_with_30_rc1_public_token(self):
        # TEST 145
        curl_params = ['-H', "Accept: application/json", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc1/" + self.limited_orcid_id + "/email"curl_params, '--insecure')
        #Check an empty email sections is returned
        self.assertTrue(self.empty_email in response, "Non-empty email retruned " + response)
    ...
    def test_read_limited_funding_with_30_rc1_public_token(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc1/" + self.limited_orcid_id + "/funding/1285"curl_params, '--insecure')
        self.assertTrue("<error-code>9038</error-code>" in response, "Expected error code 9038 instead: " + response)
    ...
    def test_read_limited_record_with_30rc2_public_token(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc2/" + self.limited_orcid_id + "/record"curl_params, '--insecure')
        response_body = response.partition('X-Frame-Options: DENY')[2]
        response_body = re.sub('(.*)(X-Content-Type-Options: nosniff)|[    ](.*)(\<common:last-modified-date\>|\<common:created-date\>)(.*)(\</common:last-modified-date\>|\</common:created-date\>)\n','', response_body)
        #Compare the body of the response to the saved file.
        self.assertTrue(response_body.strip() == open('saved_records/empty_limited_record30_rc2.xml','r').read(), 'response_body: ' + response_body)
    ...
    def test_read_limited_work_with_30rc2_public_token(self):
        ...
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc2/" + self.limited_orcid_id + "/work/141942"curl_params, '--insecure')
        self.assertTrue("<error-code>9038</error-code>" in response, "Expected error code 9038 instead: " + response)

    def test_read_limited_email_with_30rc2_public_token(self):
        # TEST 145
        curl_params = ['-H', "Accept: application/json", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc2/" + self.limited_orcid_id + "/email"curl_params, '--insecure')
        #Check an empty email sections is returned
        self.assertTrue(self.empty_email in response, "Non-empty email retruned " + response)
    ...
    def test_read_limited_funding_with_30rc2_public_token(self):
        # Test nothing is returned when limited funding is read with the public api
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.public_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc2/" + self.limited_orcid_id + "/funding/1285"curl_params, '--insecure')
        self.assertTrue("<error-code>9038</error-code>" in response, "Expected error code 9038 instead: " + response)
    ...
    def test_read_limited_record_with_30rc2_wrong_token(self):
        #TEST 149
        curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.wrong_record_token, '-L', '-i', '-k', '-X', 'GET']
        response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc2/" + self.limited_orcid_id + "/record",     curl_params)
        self.assertTrue("<error-code>9017</error-code>" in response, "Expected error code 9017 instead: " + response)

    def test_read_limited_work_with_30rc2_wrong_token(self):
       # TEST 150
       curl_params = ['-H', "Accept: application/xml", '-H', 'Authorization: Bearer ' + self.wrong_record_token, '-L', '-i', '-k', '-X', 'GET']
       response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc2/" + self.limited_orcid_id + "/work/141942",   curl_params)
       self.assertTrue("<error-code>9017</error-code>" in response, "Expected error code 9017 instead: " + response)
    ...
    def test_limited_public_json_empty(self):
        work_url = "http://" + properties.test_server + "/0000-0001-7325-5491/researchResourcePage.json?offset=0&sort=endDate&sortAsc=false&researchResourceID=1005"
        response = urllib.urlopen(work_url).read()
        print work_url
