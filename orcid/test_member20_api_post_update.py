...
class Member20ApiPostUpdate(OrcidBaseTest.OrcidBaseTest):
    ...
    def test_post_update_work(self):
        ...
        self.assertTrue("201 Created" in response.decode(), "Response missing \"Created\" tag: " + response.decode())
    ...
    def test_post_update_keyword(self):
        ...
        self.assertTrue("200 OK" in update_response.decode(), str(putcode) + " > Update Action Response: " + update_response + " with data [%s]" % updated_data)
