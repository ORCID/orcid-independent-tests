...
#3.0_rc1
    def post20(self, file_name, endpoint):
        ...
        post_response = self.orcid_curl("https://api." + self.test_server + "/v3.0_rc1/%s/%s" % (self.orcid_id, endpoint), curl_params)
    ...
    def put20(self, putjson, endpoint, putcode):
        ...
        put_response = self.orcid_curl("https://api." + self.test_server + "/v3.0_rc1/%s/%s/%s" % (self.orcid_id, endpoint, putcode), curl_params)
        return put_response
    ...
    def read20(self, endpoint):
        ...
        read_response = self.orcid_curl("https://api." + self.test_server + "/v3.0_rc1/%s/%s" % (self.orcid_id, endpoint), curl_params)
    ...
    def delete20(self, endpoint, putcode):
        ...
        delete_response = self.orcid_curl("https://api." + self.test_server + "/v3.0_rc1/%s/%s/%s" % (self.orcid_id, endpoint, putcode), curl_params)
    ...
    def issn_group(self, group_access, issn):
        ...
        post_response = self.orcid_curl("https://api.%s/v3.0_rc1/group-id-record/?group-id=%s" % (self.test_server, issn), curl_params)
        self.assertTrue("group-id" in post_response, "response: " + post_response)
        #read
        read_response = self.orcid_curl("https://api.%s/v3.0_rc1/group-id-record/1104" % (self.test_server), curl_params)
    ...
    def other_group(self, group_access, xmlfile):
        ...
        post_response = self.orcid_curl("https://api.%s/v3.0_rc1/group-id-record" % (self.test_server), post_params)
        ...
        read_response = self.orcid_curl("https://api.%s/v3.0_rc1/group-id-record/%s" % (self.test_server, putcode), curl_params)
        ...
        delete_response = self.orcid_curl("https://api.%s/v3.0_rc1/group-id-record/%s" % (self.test_server, putcode), delete_params)
    ...
    def test_client_endpoint(self):
        ...
        response = self.orcid_curl("https://pub." + self.test_server + "/v3.0_rc1/client/APP-7M3CGDKMQE36J56N", curl_params)
...
#read the record: curl -H 'Content-Type: application/orcid+xml' -H 'Authorization: Bearer f4f35385-f903-451c-9a15-cde960dca66b' -X GET 'https://api." + self.test_server + "/v3.0_rc1/0000-0002-7361-1027/fundings' -L -i -k
