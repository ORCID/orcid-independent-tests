...
#3.0_rc1
    ...
    def post_group(self, group_access, file_name, endpoint):
        ...
        post_response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc1/%s" % endpoint, curl_params)
        return post_response
    ...
    def delete_group(self, endpoint, putcode):
        ...
        delete_response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc1/%s/%s" % (endpoint, putcode), curl_params)
        return delete_response
    ...
    def read_group(self, grou_access, endpoint, putcode):
        ...
        read_response = self.orcid_curl("https://api." + properties.test_server + "/v3.0_rc1/%s/%s" % (endpoint, putcode), curl_params)
        return read_response
    ...
    def test_peer30(self):
    	jsontext = '"reviewer-role" : "reviewer", "review-identifiers" : { "external-id" : [ {"external-id-type" : "source-work-id","external-id-value" : "6666", "external-id-url" : null,"external-id-relationship" : "self"} ] }, "review-url" : null, "review-type" : "review", "review-completion-date" : { "year" : { "value" : "2006" }}, "review-group-id" : "issn:0953-1513", "subject-type" : "grant", "convening-organization" : { "name" : "ORCID", "address" : { "city" : "Bethesda", "region" : "MD", "country" : "US" }, "disambiguated-organization" : {"disambiguated-organization-identifier" : "385488", "disambiguation-source" : "RINGGOLD" }}}'
