...
#3.0_rc1
    ...
    def issn_group(self, group_access, issn):
        ...
        post_response = self.orcid_curl("https://api.%s/v3.0_rc2/group-id-record/?group-id=%s" % (self.test_server, issn), curl_params)
        self.assertTrue("group-id" in post_response, "response: " + post_response)
        #read
        read_response = self.orcid_curl("https://api.%s/v3.0_rc2/group-id-record/1104" % (self.test_server), curl_params)
    ...
    def other_group(self, group_access, xmlfile):
        ...
        post_response = self.orcid_curl("https://api.%s/v3.0_rc2/group-id-record" % (self.test_server), post_params)
        ...
        read_response = self.orcid_curl("https://api.%s/v3.0_rc2/group-id-record/%s" % (self.test_server, putcode), curl_params)
        ...
        delete_response = self.orcid_curl("https://api.%s/v3.0_rc2/group-id-record/%s" % (self.test_server, putcode), delete_params)
